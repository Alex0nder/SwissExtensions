...
Chrome MV3 extension: Swiss Command, Swiss Lens, Page Capture, Tab Hibernate, Memory Cleaner, Site Blocker, and Site Data Clear.

**Version:** see `manifest.json` (current: 1.5.50).
